 ...
 * A comma-separated list of phrases used to match tweets
 * Phrase = one or more terms separated by spaces, 
 * A phrase matches if all of the terms in the phrase are present
...
function allPossibleCombinations(array, returnArray) {
  if(typeof returnArray === undefined || returnArray == null) {
      returnArray = false;
  }
